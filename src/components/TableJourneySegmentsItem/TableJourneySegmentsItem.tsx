...
import styles from './TableJourneySegmentsItem.module.scss';
...
const TableJourneySegmentsItem: FC<TableJourneySegmentsItemProps> = ({
  ...
  return (
    <div className={styles.TableJourneySegmentsItem + classGridTemplate}>
      <div>{data?.name}</div>
      <div>{data?.event}</div>
      <div className={styles.TableJourneySegmentsItem__icons}>
