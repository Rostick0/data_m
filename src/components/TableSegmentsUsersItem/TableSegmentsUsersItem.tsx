  ...
  >
    <Link to={'/segments/users/' + data?.id} className={styles.TableSegmentsUsersItem__email}>
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M12.0015 11.821C14.5733 11.821 16.6581 9.73615 16.6581 7.16439C16.6581 4.59264 14.5733 2.50781 12.0015 2.50781C9.42978 2.50781 7.34496 4.59264 7.34496 7.16439C7.34496 9.73615 9.42978 11.821 12.0015 11.821Z" stroke="#142333" stroke-opacity="0.33" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M20 21.1344C20 17.5303 16.4144 14.6152 12 14.6152C7.58557 14.6152 4 17.5303 4 21.1344" stroke="#142333" stroke-opacity="0.33" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
      </svg>
