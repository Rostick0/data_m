...
import styles from './TableCronsItem.module.scss';
...
const TableCronsItem: FC<TableCronsItemProps> = ({
  data,
  info,
  statistic,
  statistic_2,
  ...
  const classActive = isShow ? ' ' + styles.TableCronsItem_active : '';
  ...
  return (
    <div className={styles.TableCronsItem + classActive}>
      <div className={styles.TableCronsItem__short + classGridTemplate}>
        <div className={styles.TableCronsItem__name}
          onClick={() => setIsShow(prev => !prev)}
        >
          <svg className={styles.TableCronsItem__arrow} width="6" height="10" viewBox="0 0 6 10" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="">{data?.template}</div>
        <div className="">{data?.type}</div>
        <div className="">{data?.date}</div>
        <div className="">{data?.period}</div>
        <div className={styles.TableCronsItem__tags}>
          {data?.tags?.map(tag => <Tag key={tag}>{tag}</Tag>)}
        </div>
        <div className="">{data?.rollback}</div>
        <TableItemIcons className={styles.TableCronsItem__icons}>
          {data?.is_active ?
            (
              <>
            ...
            (
              <>
                ...
                <div className={styles.TableCronsItem__application}>
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <ul className={styles.TableCronsItem__menu}>
                    <li className={styles.TableCronsItem__menu_item}>
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {
        isShow && (
          <div className={styles.TableCronsItem__info}>
            <div className={styles.TableCronsItem__info_left}>
              <div className={styles.TableCronsItem__block}>
                <div className={styles.TableCronsItem__block_flex}>
                  <div className={styles.TableCronsItem__block_name}>Id</div>
                  <div className={styles.TableCronsItem__block_value}>{info?.id}</div>
                </div>
                <div className={styles.TableCronsItem__block_flex}>
                  <div className={styles.TableCronsItem__block_name}>Тип</div>
                  <div className={styles.TableCronsItem__block_value}>{info?.type}</div>
                </div>
                <div className={styles.TableCronsItem__block_flex}>
                  <div className={styles.TableCronsItem__block_name}>Ключи</div>
                  <div className={styles.TableCronsItem__block_value}>
                    {info?.keys?.map(key => (
                ...
                <div className={styles.TableCronsItem__block_flex}>
                  <div className={styles.TableCronsItem__block_name}>Начало отправки</div>
                  <div className={styles.TableCronsItem__block_value}>{info?.date_start}</div>
                </div>
                <div className={styles.TableCronsItem__block_flex}>
                  <div className={styles.TableCronsItem__block_name}>Окончание отправки</div>
                  <div className={styles.TableCronsItem__block_value}>{info?.date_end}</div>
                </div>
                <div className={styles.TableCronsItem__block_flex}>
                  <div className={styles.TableCronsItem__block_name}>Тип получателя</div>
                  <div className={styles.TableCronsItem__block_value}>{info?.type_recipient}</div>
                </div>
                <div className={styles.TableCronsItem__block_flex}>
                  <div className={styles.TableCronsItem__block_name}>Сегменты</div>
                  <div className={styles.TableCronsItem__block_value}>
                    {info?.segments?.map(segment => (
                      <Tag key={segment} className={styles.TableCronsItem__block_tag}>{segment}</Tag>
                    ))}
                  </div>
                </div>
                <div className={styles.TableCronsItem__block_flex}>
                  <div className={styles.TableCronsItem__block_name}>Тип пуш-уведомления</div>
                  <div className={styles.TableCronsItem__block_value}>{info?.type_push}</div>
                </div>
              </div>
              <div className={styles.TableCronsItem__statistic + ' ' + styles.TableCronsItem__block}>
                <div className={styles.TableCronsItem__block_name}>Статистика</div>
                <div className={styles.TableCronsItem__charts}>
                  <div className={styles.TableCronsItem__chart}>
                    <Doughnut
                      data={data1}
                      width="100%"
                    ></Doughnut>
                    <span className={styles.TableCronsItem__chart_info}>
                      <div className={styles.TableCronsItem__chart_flex}>
                        <div className={styles.TableCronsItem__chart_icon}
                          style={{ backgroundColor: '#F4BE37' }}
                        ></div>
                        <div className={styles.TableCronsItem__chart_name}>Успешно</div>
                        <div>{statistic?.successfully}</div>
                      </div>
                      <div className={styles.TableCronsItem__chart_flex}>
                        <div className={styles.TableCronsItem__chart_icon}></div>
                        <div className={styles.TableCronsItem__chart_name}>Всего</div>
                  ...
                  <div className={styles.TableCronsItem__chart}>
                    <Doughnut
                      ...
                      width="50%"
                    ></Doughnut>
                    <div className={styles.TableCronsItem__chart_info}>
                      <div className={styles.TableCronsItem__chart_flex}>
                        <div className={styles.TableCronsItem__chart_icon}
                          style={{ backgroundColor: 'var(--brand_primary_2)' }}
                        ></div>
                        <div className={styles.TableCronsItem__chart_name}>Отправлено</div>
                      ...
                      <div className={styles.TableCronsItem__chart_flex}>
                        ...
                        ></div>
                        <div className={styles.TableCronsItem__chart_name}>Прочитано</div>
                      ...
                      <div className={styles.TableCronsItem__chart_flex}>
                        <div className={styles.TableCronsItem__chart_icon}
                          style={{ backgroundColor: '#F4BE37' }}
                        ></div>
                        <div className={styles.TableCronsItem__chart_name}>Получено</div>
            ...
            <div className={styles.TableCronsItem__block + ' ' + styles.TableCronsItem__info_right}>
              <div className={styles.TableCronsItem__block_flex_column}>
                <div className={styles.TableCronsItem__block_name}>Заголовок</div>
                <div className={styles.TableCronsItem__block_value}>{info?.title}</div>
              </div>
              <div className={styles.TableCronsItem__block_flex_column}>
                <div className={styles.TableCronsItem__block_name}>Текст</div>
                <div className={styles.TableCronsItem__block_value}>{info?.text}</div>
              </div>
              <div className={styles.TableCronsItem__block_flex_column}>
                <div className={styles.TableCronsItem__block_name}>Внутренняя ссылка</div>
                <div className={styles.TableCronsItem__block_value}>{info?.link}</div>
              </div>
              <div className={styles.TableCronsItem__block_flex_column}>
                <div className={styles.TableCronsItem__block_name}>Превью</div>
                <div className={styles.TableCronsItem__block_value}>
                  <div className={styles.TableCronsItem__block_images}>
                    {info?.preview?.map(previewItem => (
                      <div key={previewItem?.name} className={styles.TableCronsItem__block_image}>
              ...
              <div className={styles.TableCronsItem__block_flex_column}>
                <div className={styles.TableCronsItem__block_name}>Сообщение</div>
                <div className={styles.TableCronsItem__block_value}>{info?.message}</div>
              </div>
            </div>
          </div>
        )
