...
import TableJourney from '../../components/TableJourney/TableJourney';
  ...
  return (
    <>
      ...
      <div className={styles.JourneyList}>
        <div className={styles.JourneyList__top}>
          <Title>
            <div className={styles.JourneyList__title}>
              <div>Маршруты</div>
              <Link to="/journey/view">
                <Button
          ...
          <div className={styles.JourneyList__filter}>
