...
const BroadcastList: FC<BroadcastListProps> = () => (
  <div className={styles.BroadcastList}>
    ...
    <div className={styles.BroadcastList__titles}>
      <div className={styles.BroadcastList__title}>Наименование</div>
      <div className={styles.BroadcastList__title}>Тип</div>
      <div className={styles.BroadcastList__title}>Польз. в проц./всего</div>
      <div className={styles.BroadcastList__title}>Теги</div>
      <div className={styles.BroadcastList__title}>Дата и время</div>
      <div className={styles.BroadcastList__title}>Статус</div>
      <div className={styles.BroadcastList__title}>Папка</div>
    </div>
    <ul className={styles.BroadcastList__list}>
      <li className={styles.BroadcastList__item}>
        <div className={styles.BroadcastList__item_short}>
          <div className={styles.BroadcastList__item_name}>
            <svg width="6" height="10" viewBox="0 0 6 10" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M0 9.03125C0 9.59375 0.65625 9.875 1.0625 9.46875L5.0625 5.46875C5.3125 5.21875 5.3125 4.8125 5.0625 4.5625L1.0625 0.5625C0.65625 0.15625 0 0.4375 0 1V9.03125Z" fill="#142333" fill-opacity="0.33" />
            </svg>
            <div>Наименование</div>
          </div>
          <div className="">E-mail</div>
          <div className="">88/134</div>
          <div className=""><InputTag>Default</InputTag></div>
        ...
        <div className={styles.BroadcastList__item_info}>
