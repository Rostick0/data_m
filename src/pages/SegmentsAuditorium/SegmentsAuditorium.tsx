...
import styles from './SegmentsAuditorium.module.scss';
...
interface SegmentsAuditoriumProps { }

const SegmentsAuditorium: FC<SegmentsAuditoriumProps> = () => {
  const links = [
    {
      id: 1,
  ...
  return (
    <div className={styles.SegmentsAuditorium}>
      <TopNav links={links}>
      ...
      <div className={styles.SegmentsAuditorium__content}>
        <div className={styles.SegmentsAuditorium__top}>
          <div className={styles.SegmentsAuditorium__title}>
            Давайте создадим аудиторию
          </div>
          <div className={styles.SegmentsAuditorium__subtitle}>
            Lorem ipsum dolor sit amet consectetur. Vitae morbi vitae condimentum orci in sit. Lorem ipsum dolor sit amet consectetur. Vitae morbi vitae condimentum orci in sit.
          </div>
        </div>
        <form className={styles.SegmentsAuditorium__form}>
          <div className={styles.SegmentsAuditorium__form_top}>
            <FieldItemUi
              title="Наименование"
            >
              <Input
          ...
          <div className={styles.SegmentsAuditorium__form_bottom}>
            <SegmentItemInputs
              hiddenFirstIcon
            >
              <Select
                className={styles.SegmentsAuditorium__select_first}
                defaultValue="Все группы верны"
              ></Select>
              <Button
            ...
            <SegmentItemInputs
              hasIconApplication
            >
              <Select placeholder='Выбрать фильтр'></Select>
              <Button
                className='button_with_icon'
                styleColor='grey'
              >
...
export default SegmentsAuditorium;
