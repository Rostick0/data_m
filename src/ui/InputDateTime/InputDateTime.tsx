...
import './../InputDate/calendar.scss';
import Calendar from 'react-calendar';
import Input from '../Input/Input';
import { InputDateProps } from '../InputDate/InputDate';

interface InputDateTimeProps extends InputDateProps { }
...
const InputDateTime: FC<InputDateTimeProps> = ({
  ...
  return (
    <div
      className={styles.InputDateTime + ' InputDate ' + styleClassName}
      tabIndex={-1}
      onBlur={() => setIsActive(false)}
    >
      <div className={styles.InputDateTime__field}
